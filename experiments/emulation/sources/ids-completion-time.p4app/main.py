...
timing = P4Program('timing.p4')
dt = P4Program('no_DT.p4')
...
class LinearTopo(Topo):
    def __init__(self, **opts):
        ...
        s1 = self.addSwitch("s1", program=timing)
        s2 = self.addSwitch("s2", program=dt)
...
def config_network():
    ...
    net = P4Mininet(program=timing, topo=topo, link=link)
    net.start()
