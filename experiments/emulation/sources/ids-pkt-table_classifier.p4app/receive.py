...
dic = {'eth0': 'benigno', 'h2-eth1': 'dos_hulk', 'h2-eth2': 'dos_goldeneye', 'h2-eth3': 'dos_slowhttptest', 'h2-eth4': 'wa_brute_force', 'h2-eth5': 'dos_slowloris', 'h2-eth6': 'i_portscan', 'h2-eth7': '...'}
