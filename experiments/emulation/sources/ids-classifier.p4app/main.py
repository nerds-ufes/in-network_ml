...
def config_network():
    ...
    sw.command("table_add ipv4_class ipv4_forward [0, 5, 6, 7] => 00:00:00:00:02:02 2")
    sw.command("table_add ipv4_class ipv4_forward [16, 17, 18] => 00:00:00:00:03:03 3")
...
def main():
    ...
    print "TCPREPLAY"
    print h1.cmd( 'tcpreplay -i eth0 pcap/wed.pcap' ) 
