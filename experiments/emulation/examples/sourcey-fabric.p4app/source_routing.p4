/* -*- P4_16 -*- */
// See more complex tunnel example at https://github.com/jafingerhut/p4-guide/tree/master/rewrite-examples
#include <core.p4>
#include <v1model.p4>

const bit<16> TYPE_IPV4 = 0x800;
const bit<16> TYPE_SRCROUTING = 0x1234;
const bit<5> TUNNEL_TYPE_SR = 0;
...
parser MyParser(packet_in packet,
    ...
    state parse_srcRouting {
        meta.tunnel_type = TUNNEL_TYPE_SR;
...
/*************************************************************************
****************  T U N N E L   P R O C E S S I N G   *******************
*************************************************************************/
